...
QUALITY_GATE_REGISTRY = {
    ...
    "storyboard_preview_quality_gate": ("previsualization", "7.0.3"),
    "storyboard_preview_approval": ("approval", "7.0.3, 8.0.3"),
...
GATE_DEFINITIONS: dict[str, dict[str, Any]] = {
    ...
    "storyboard_preview_quality_gate": {
        ...
        "non_waivable_checks": [
            "all_shots_covered",
            "shot_order_preserved",
            "five_review_dimensions_present",
            "frames_hash_verified",
            "animatic_hash_verified",
            "runway_not_contacted",
            "watermark_present",
            "non_publishable",
        ],
    },
    "storyboard_preview_approval": {
        ...
        "threshold": 1.0,
        "dependencies": ["storyboard_preview_quality_gate"],
    },
