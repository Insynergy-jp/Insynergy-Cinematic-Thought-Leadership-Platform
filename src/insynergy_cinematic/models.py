...
class BuildState(StrEnum):
    CREATED = "CREATED"
    PERSONA_PLANNING = "PERSONA_PLANNING"
    AWAITING_PERSONA_APPROVAL = "AWAITING_PERSONA_APPROVAL"
    PLANNING = "PLANNING"
    PLANNED = "PLANNED"
    AWAITING_STORYBOARD_PREVIEW_APPROVAL = "AWAITING_STORYBOARD_PREVIEW_APPROVAL"
