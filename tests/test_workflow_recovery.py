...
class WorkflowRecoveryTests(unittest.TestCase):
    ...
    def test_workflows_preserve_persona_evidence_and_bind_recovery_to_source(self) -> None:
        ...
        self.assertIn("full_auto_v13_rage_recovery", execute)
        self.assertIn("full-auto-v13-ja-rage-v1", execute)
        self.assertIn("full-auto-v13-shot7-rage-v1", execute)
        self.assertIn("30072914399", execute)
